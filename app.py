...
if st.session_state.cached_data is None:
        ...
        if market_val == "Taiwan":
            st.session_state.cached_data = [
                ...
                {'symbol': '2308', 'name': '台達電', 'sector': 'Technology', 'price': 580.0, 'pe': 24.0, 'pb': 5.0, 'div_yield': 1.8, 'roe': 22.0, 'debt': 30, 'profit_margin': 12, 'yoy': 6.0, 'eps_growth': 10.0},
                {'symbol': '2609', 'name': '陽明', 'sector': 'Shipping', 'price': 95.0, 'pe': 8.0, 'pb': 1.5, 'div_yield': 3.0, 'roe': 20.0, 'debt': 60, 'profit_margin': 15, 'yoy': -10.0, 'eps_growth': -20.0},
                {'symbol': '2615', 'name': '長榮', 'sector': 'Shipping', 'price': 180.0, 'pe': 10.0, 'pb': 2.0, 'div_yield': 2.5, 'roe': 25.0, 'debt': 55, 'profit_margin': 20, 'yoy': -5.0, 'eps_growth': -15.0},
                {'symbol': '2105', 'name': '正新', 'sector': 'Auto', 'price': 48.0, 'pe': 20.0, 'pb': 1.8, 'div_yield': 4.0, 'roe': 10.0, 'debt': 40, 'profit_margin': 8, 'yoy': 1.0, 'eps_growth': 2.0},
                {'symbol': '8046', 'name': '楠梓電', 'sector': 'Technology', 'price': 120.0, 'pe': 15.0, 'pb': 2.5, 'div_yield': 2.0, 'roe': 18.0, 'debt': 35, 'profit_margin': 10, 'yoy': 3.0, 'eps_growth': 5.0},
                {'symbol': '2474', 'name': '浩鼎', 'sector': 'Pharma', 'price': 85.0, 'pe': 35.0, 'pb': 4.0, 'div_yield': 0.0, 'roe': 12.0, 'debt': 20, 'profit_margin': -10, 'yoy': 10.0, 'eps_growth': 5.0},
                {'symbol': '2881', 'name': '富邦金', 'sector': 'Finance', 'price': 85.0, 'pe': 12.0, 'pb': 1.4, 'div_yield': 3.0, 'roe': 12.0, 'debt': 45, 'profit_margin': 25, 'yoy': 5.0, 'eps_growth': 8.0},
                {'symbol': '2883', 'name': '開發金', 'sector': 'Finance', 'price': 28.0, 'pe': 15.0, 'pb': 1.0, 'div_yield': 2.5, 'roe': 8.0, 'debt': 50, 'profit_margin': 15, 'yoy': 3.0, 'eps_growth': 4.0},
                {'symbol': '2884', 'name': '元大金', 'sector': 'Finance', 'price': 45.0, 'pe': 14.0, 'pb': 1.2, 'div_yield': 3.0, 'roe': 10.0, 'debt': 48, 'profit_margin': 20, 'yoy': 4.0, 'eps_growth': 6.0},
                {'symbol': '2885', 'name': '元大期', 'sector': 'Finance', 'price': 120.0, 'pe': 18.0, 'pb': 3.0, 'div_yield': 2.0, 'roe': 18.0, 'debt': 30, 'profit_margin': 30, 'yoy': 8.0, 'eps_growth': 10.0},
                {'symbol': '2886', 'name': '兆豐金', 'sector': 'Finance', 'price': 42.0, 'pe': 16.0, 'pb': 1.3, 'div_yield': 3.5, 'roe': 12.0, 'debt': 45, 'profit_margin': 28, 'yoy': 2.0, 'eps_growth': 3.0},
                {'symbol': '2887', 'name': '台新金', 'sector': 'Finance', 'price': 25.0, 'pe': 12.0, 'pb': 1.1, 'div_yield': 2.8, 'roe': 10.0, 'debt': 50, 'profit_margin': 18, 'yoy': 3.0, 'eps_growth': 5.0},
                {'symbol': '2888', 'name': '新光金', 'sector': 'Finance', 'price': 15.0, 'pe': 20.0, 'pb': 1.0, 'div_yield': 2.0, 'roe': 5.0, 'debt': 60, 'profit_margin': 10, 'yoy': 1.0, 'eps_growth': 2.0},
                {'symbol': '2889', 'name': '京城銀', 'sector': 'Finance', 'price': 38.0, 'pe': 14.0, 'pb': 1.2, 'div_yield': 3.2, 'roe': 10.0, 'debt': 42, 'profit_margin': 22, 'yoy': 4.0, 'eps_growth': 6.0},
                {'symbol': '2890', 'name': '永豐金', 'sector': 'Finance', 'price': 22.0, 'pe': 13.0, 'pb': 1.0, 'div_yield': 3.0, 'roe': 9.0, 'debt': 48, 'profit_margin': 15, 'yoy': 2.0, 'eps_growth': 4.0},
                {'symbol': '2892', 'name': '第一金', 'sector': 'Finance', 'price': 35.0, 'pe': 15.0, 'pb': 1.3, 'div_yield': 3.0, 'roe': 10.0, 'debt': 44, 'profit_margin': 20, 'yoy': 3.0, 'eps_growth': 5.0},
                {'symbol': '3034', 'name': '聯詠', 'sector': 'Technology', 'price': 680.0, 'pe': 22.0, 'pb': 5.0, 'div_yield': 1.5, 'roe': 25.0, 'debt': 25, 'profit_margin': 30, 'yoy': 10.0, 'eps_growth': 15.0},
                {'symbol': '2301', 'name': '光寶科', 'sector': 'Technology', 'price': 115.0, 'pe': 18.0, 'pb': 2.5, 'div_yield': 2.5, 'roe': 15.0, 'debt': 35, 'profit_margin': 10, 'yoy': 3.0, 'eps_growth': 5.0},
                {'symbol': '2303', 'name': '聯電', 'sector': 'Technology', 'price': 52.0, 'pe': 14.0, 'pb': 1.8, 'div_yield': 3.5, 'roe': 15.0, 'debt': 38, 'profit_margin': 25, 'yoy': -5.0, 'eps_growth': -10.0},
                {'symbol': '2377', 'name': '微星', 'sector': 'Technology', 'price': 185.0, 'pe': 16.0, 'pb': 3.0, 'div_yield': 2.0, 'roe': 20.0, 'debt': 30, 'profit_margin': 8, 'yoy': 5.0, 'eps_growth': 8.0},
                {'symbol': '2353', 'name': '宏碁', 'sector': 'Technology', 'price': 42.0, 'pe': 12.0, 'pb': 1.5, 'div_yield': 4.0, 'roe': 12.0, 'debt': 45, 'profit_margin': 5, 'yoy': 2.0, 'eps_growth': 3.0},
                {'symbol': '2344', 'name': '華邦電', 'sector': 'Technology', 'price': 35.0, 'pe': 25.0, 'pb': 2.0, 'div_yield': 1.5, 'roe': 8.0, 'debt': 40, 'profit_margin': 10, 'yoy': -3.0, 'eps_growth': -5.0},
                {'symbol': '2327', 'name': '國巨', 'sector': 'Technology', 'price': 520.0, 'pe': 18.0, 'pb': 4.0, 'div_yield': 1.2, 'roe': 22.0, 'debt': 28, 'profit_margin': 25, 'yoy': 5.0, 'eps_growth': 8.0},
                {'symbol': '2315', 'name': '廣訊', 'sector': 'Technology', 'price': 180.0, 'pe': 20.0, 'pb': 3.5, 'div_yield': 1.5, 'roe': 18.0, 'debt': 32, 'profit_margin': 12, 'yoy': 6.0, 'eps_growth': 10.0},
                {'symbol': '2408', 'name': '南亞科', 'sector': 'Technology', 'price': 85.0, 'pe': 30.0, 'pb': 2.5, 'div_yield': 1.0, 'roe': 8.0, 'debt': 35, 'profit_margin': 15, 'yoy': -8.0, 'eps_growth': -15.0},
                {'symbol': '2409', 'name': '友達', 'sector': 'Technology', 'price': 18.0, 'pe': 40.0, 'pb': 1.0, 'div_yield': 2.0, 'roe': 3.0, 'debt': 50, 'profit_margin': 2, 'yoy': -15.0, 'eps_growth': -25.0},
                {'symbol': '2413', 'name': '環球晶', 'sector': 'Technology', 'price': 580.0, 'pe': 15.0, 'pb': 3.5, 'div_yield': 2.0, 'roe': 25.0, 'debt': 30, 'profit_margin': 30, 'yoy': -5.0, 'eps_growth': -10.0},
                {'symbol': '2420', 'name': '新巨', 'sector': 'Technology', 'price': 42.0, 'pe': 16.0, 'pb': 2.0, 'div_yield': 3.0, 'roe': 12.0, 'debt': 35, 'profit_margin': 10, 'yoy': 2.0, 'eps_growth': 4.0},
                {'symbol': '2421', 'name': '建準', 'sector': 'Technology', 'price': 85.0, 'pe': 18.0, 'pb': 2.5, 'div_yield': 2.5, 'roe': 14.0, 'debt': 32, 'profit_margin': 12, 'yoy': 4.0, 'eps_growth': 6.0},
                {'symbol': '2439', 'name': '美律', 'sector': 'Technology', 'price': 165.0, 'pe': 20.0, 'pb': 4.0, 'div_yield': 1.5, 'roe': 20.0, 'debt': 25, 'profit_margin': 15, 'yoy': 8.0, 'eps_growth': 12.0},
                {'symbol': '2441', 'name': '超聲', 'sector': 'Technology', 'price': 92.0, 'pe': 22.0, 'pb': 3.0, 'div_yield': 2.0, 'roe': 15.0, 'debt': 28, 'profit_margin': 12, 'yoy': 5.0, 'eps_growth': 8.0},
                {'symbol': '2443', 'name': '億光', 'sector': 'Technology', 'price': 45.0, 'pe': 18.0, 'pb': 1.8, 'div_yield': 3.0, 'roe': 10.0, 'debt': 35, 'profit_margin': 8, 'yoy': 1.0, 'eps_growth': 2.0},
                {'symbol': '2444', 'name': '聯強', 'sector': 'Technology', 'price': 48.0, 'pe': 14.0, 'pb': 2.0, 'div_yield': 4.5, 'roe': 15.0, 'debt': 40, 'profit_margin': 5, 'yoy': 3.0, 'eps_growth': 5.0},
                {'symbol': '2445', 'name': '浩勤', 'sector': 'Technology', 'price': 125.0, 'pe': 20.0, 'pb': 3.2, 'div_yield': 1.8, 'roe': 16.0, 'debt': 30, 'profit_margin': 14, 'yoy': 6.0, 'eps_growth': 9.0},
                {'symbol': '2002', 'name': '中鋼', 'sector': 'Steel', 'price': 28.0, 'pe': 15.0, 'pb': 1.2, 'div_yield': 4.0, 'roe': 8.0, 'debt': 45, 'profit_margin': 5, 'yoy': -8.0, 'eps_growth': -12.0},
                {'symbol': '2103', 'name': '台橡', 'sector': 'Chemical', 'price': 35.0, 'pe': 20.0, 'pb': 1.5, 'div_yield': 3.0, 'roe': 8.0, 'debt': 38, 'profit_margin': 6, 'yoy': -2.0, 'eps_growth': -5.0},
            ]
        else:
            st.session_state.cached_data = [
